...
public class MimismartTestContainer extends TestContainer {

    public MimismartTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/mimismart/app.properties",
    ...
    public static class Common extends MimismartTestContainer {

        public static final MimismartTestContainer.Common INSTANCE = new MimismartTestContainer.Common();
